...
spark.sql(
    """
    CREATE TABLE IF NOT EXISTS demo_youssef.youssef.table_sizess (
        size_in_mb DOUBLE,
        catalog STRING,
        schema STRING,
        table STRING
...
sizes_df.write.mode("append").insertInto("demo_youssef.youssef.table_sizess")
...
spark.sql(
    """
    CREATE TABLE IF NOT EXISTS demo_youssef.youssef.table_sizes (
        size_in_mb DOUBLE,
        catalog STRING,
        schema STRING,
        table STRING
...
sizes_df.write.mode("append").insertInto("demo_youssef.youssef.table_sizes")
